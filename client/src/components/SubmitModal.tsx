...
const SubmitModal: FC<Props> = ({
  ...
  const url = "http://localhost:3003/recieveForm";
        ...
        {(state: string) => (
          ...
          >
            ...
            >
              ...
              <DialogContent>
                Tell something to yourself in the future about this anime.
              </DialogContent>
              <div>
                <div>
                    ...
                    <Stack spacing={0}>
                      ...
                      <FormControl>
                        ...
                        <Form.Control
                          ...
                          name="description"
                          type="text"
                          onChange={setDescriptioninputHandler}
                        />
                      </FormControl>
                            ...
                            {[
                              ...
                              <ListItem key={item}>
                                ...
                                <Checkbox
                                  ...
                                  variant={
                                    genre.includes(item) ? "soft" : "outlined"
                                  }
                                  onChange={(
